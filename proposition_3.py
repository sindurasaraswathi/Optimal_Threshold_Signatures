...
def main2(v, a, b, lambda_, gamma):
    ...
    # def p_t2(t2, t, a):
    #     return (1-a*0.5*t2**2) * np.exp(-lambda_ * t)
    
    # def q_t2(t2, t, b):
    #     return (1-b*0.5*t2**2) * np.exp(-gamma * t)
...
if __name__ == '__main__':
    ...
    lmda = [i*0.02 for i in range(1, 10)]
    gma = [i*0.002 for i in range(1, 10)]
    ...
    pivot_t1 = df.pivot(index='a', columns='b', values='t1*')
    pivot_t2 = df.pivot(index='a', columns='b', values='t2*')
